...
1.  **La salida es "Asíncrona" (Transparente):** La salida de la RAM se comporta como **lógica combinacional** con respecto a la entrada de dirección (*Address*).
...
2.  **Evidencia en el diseño de Petzold:** El diseño de Petzold en el capítulo "Automation" demuestra que la salida de la RAM no tiene un *latch* interno ni está disparada. Si observas el diagrama completo de la computadora:
...
3.  **Distinción entre Escritura y Lectura:**
...
1.  **La RAM de Petzold (SRAM Asíncrona):**
...
1. El contador cambia.
2. La RAM emite basura y luego se estabiliza en el dato correcto.
3. **Entonces** llega el flanco de reloj.
4. El *Instruction Latch* toma una "foto" de los datos ya estables y los envía al resto de la computadora.
...
1.  **El Problema: Tráfico de "Pare y Siga" (Asíncrono)**
...
2.  **La Solución: La "Cinta Transportadora" (Síncrono/Pipelining)**
...
3.  **El problema físico: "Signal Skew" (Desviación de señal)**
